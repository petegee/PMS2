...
/* ------------------------------------------------------------------------------------------*\
   PMS 2 bottom hinged flap.
\* ------------------------------------------------------------------------------------------*/
 float distanceServoHingeX = 50;          //distance from servo pivot point to the surface pivot point in X axis
 float distanceServoHingeY = -6;         //distance from servo pivot point to the surface pivot point in Y axis
 float servoHornLen = 6;                 //length of servo horn
 float controlHornLen = 11;               //length of control horn
 float pushrodLen = 56.5;                   //length of push-rod
 float surfaceHornAngle = radians(78);   //angle between control surface and control horn
 float surfaceLen = 37;                   //length of control surface
 float wingHeightAtServo = 10;            //wing height (distance in Y axis) at the servo pivot point
 float wingHeightAtHinge = 10;            //wing height (distance in Y axis) at the control surface hinge point
 ...
 float verticalMarkerLocation = 12;       // A optional vertical marker that can be used to measure something
