...
/* ------------------------------------------------------------------------------------------*\
   PMS 2 bottom-hinged aileron
\* ------------------------------------------------------------------------------------------*/
 float distanceServoHingeX = 44;          //distance from servo pivot point to the surface pivot point in X axis
 float distanceServoHingeY = -5;         //distance from servo pivot point to the surface pivot point in Y axis
 float servoHornLen = 6;                 //length of servo horn
 float controlHornLen = 11.0;               //length of control horn
 float pushrodLen = 46;                   //length of push-rod
 float surfaceHornAngle = radians(74);   //angle between control surface and control horn
 float surfaceLen = 32;                   //length of control surface
 float wingHeightAtServo = 12.5;            //wing height (distance in Y axis) at the servo pivot point
 float wingHeightAtHinge = 8;            //wing height (distance in Y axis) at the control surface hinge point
 ...
 float verticalMarkerLocation = 13;       // A optional vertical marker that can be used to measure something
